...
export default function Consultas() {
    ...
    function ListarTodas() {
        axios('http://192.168.15.80:5000/api/Consultas', {
            headers: {
    ...
    function ListarPorUsuario() {
        axios('http://192.168.15.80:5000/api/Consultas/ListarMinhas', {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('usuario-login'),
            },
        }).then((resposta) => {
    ...
    function ListarSituacoes() {
        axios('http://192.168.15.80:5000/api/Situacoes', {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('usuario-login'),
            },
        }).then((resposta) => {
    ...
    function AgendarConsulta(Evento) {
        ...
        if (IdPaciente !== 0 && IdMedico !== 0) {
            setIsLoading(true);
            if (Descricao === '') {
                axios.post('http://192.168.15.80:5000/api/Consultas', {
    ...
    function CancelarConsulta(Evento, idConsultaCancelada) {
        ...
        axios.patch('http://192.168.15.80:5000/api/Consultas/Cancelar/' + idConsultaCancelada, null, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('usuario-login'),
            },
        }).then((resposta) => {
    ...
    function AlterarDescricao(Evento, IdConsulta) {
        Evento.preventDefault();
        setIsLoading(true);
        axios.patch('http://192.168.15.80:5000/api/Consultas/AlterarDescricao/'+IdConsulta, {
